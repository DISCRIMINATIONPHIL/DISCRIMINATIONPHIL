...
// ===========================================
// TAGALOG POPUP NOTIFICATION
// ===========================================
const tagalogLink = document.getElementById('tagalogLink');

if (tagalogLink) {
    tagalogLink.addEventListener('click', function(e) {
        e.preventDefault(); // Stop the link from going anywhere
        
        // Create popup element
        const popup = document.createElement('div');
        popup.className = 'tagalog-popup';
        popup.innerHTML = `
            <div class="popup-content">
                <i class="fas fa-language popup-icon"></i>
                <h3>Not Available Yet</h3>
                <p>The Tagalog version is currently in development. Please use the English version for now.</p>
                <p class="popup-small">We're working hard to bring you content in Tagalog soon!</p>
